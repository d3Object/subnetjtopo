                                    ...
                                    if (itemZ.nodeZ.tip == nodeThis.portText) {
                                        setTimeout(function() {
                                            ...
                                            if (nodeThis.y - nodeThis.inLinks[0].nodeA.y) {
                                                itemZ.nodeZ.y = Math.abs((nodeThis.y - nodeThis.inLinks[0].nodeA.y) / 2) + Math.min(nodeThis.y, nodeThis.inLinks[0].nodeA.y);
                                            } else {
            ...
            var portal = {
                        ...
                        success: function(data) {
                            if (data.length) {
                                ...
                                data.forEach(function(item) {
                                    $(".addOption").append($('<tr>' + '<td class="tdtext cursor">' + item.substr(13) + '</td>' + '<td class="Stime">' + '<span class="showTime">' + portal.fun.getLocaltime(item.substr(0, 13) / 1000) + '</span>' + '<span class="hideTime hide">' + item.substr(0, 13) + '</span></td>+' + '' + '<td data-toggle="tooltip" data-original-title="删除此行">' + '<i class="glyphicon glyphicon-remove removeli close "></i>' + '</td></tr>').on("click",
                ...
                "tool": {
                    "homeNode": function(data) {
                        ...
                        $.each(tempArry,
                        function(i, v) {
                            var x = Math.random() * parseInt(window.innerWidth * 0.6) + parseInt(window.innerWidth * 0.2);
                            var y = Math.random() * parseInt((window.innerHeight - $(".navbar-logo").height() - 20) * 0.6) + parseInt((window.innerHeight - $(".navbar-logo ").height() - 20) * 0.2);
                            for (var j = 0; j < data.length; j++) {
                                if (v == data[j].from_ip) {
                                    if (data[j].from_type == "subnet") {
                                        var color = "255,255,0";
                                    } else if (data[j].from_type == "server" || data[j].from_type == "web" || data[j].from_type == "costomer") {
                                        var color = "7,237,15";
                                    } else {
                                    ...
                                    if (data[j].to_type == "subnet") {
                                        var color = "255,255,0";
                                    } else if (data[j].to_type == "server" || data[j].to_type == "web" || data[j].to_type == "costomer") {
                                        var color = "7,237,15";
                                    } else {
                                        var color = "223,227,219";
                                    }
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            // 此处应该判断KPI为啥值
                            portal.Jnode.linkValue($(".kpi").children("option:selected").val(), data[i].value, ilink);
                            try {
                                ...
                                if (userSaveJson.length > 7) {
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(sdata) {
                                            if (sdata) {
                                                $(".addOption").append($('<tr>' + '<td class="tdtext cursor">' + userSaveJson + '</td>' + '<td class="Stime">' + '<span class="showTime">' + portal.fun.getLocaltime(time / 1000) + '</span>' + '<span class="hideTime hide">' + time + '</span></td>+' + '' + '<td data-toggle="tooltip" data-original-title="删除此行">' + '<i class="glyphicon glyphicon-remove removeli close"></i>' + '</td></tr>').on("click",
                                                function() {})).parent().addClass("hide");
                                                $(".qsave").removeClass("hide");
                                                // 重新渲染用户保存的状态
                                                $(".tdtext").click(function() {
                    ...
                    "help": function() {
                        ...
                        var tuli = "<ul>" + "<li>" + "为了获得好的体验效果请务必使用谷歌内核浏览器浏览本产品,万分感谢!" + "</li>" + "<li>" + "导航栏：" + "</li>" + "<li>" + "下拉框：可根据您的选择重新渲染页面的对应KPI值" + "</li>" + "<li>" + "查询：在输入框输入IP进行查询可找到当前页面的所有IP;支持模糊查找;如输入“90”;找到“192.190.1.20”;" + "若查询的是某个网段的某个IP则建议输入前三位即可;如输入“192.168.1”找到“192.168.1.1/24”" + "</li>" + "<li>" + "告警提示：可切换是否显示告警(默认显示告警)" + "</li>" + "<li>" + "工具栏" + "</li>" + "<li>" + "初始状态：可回到进入此页面初始的画面" + "</li>" + "<li>" + "框选/退出框选模式：不能拖个整个画布;只能对IP点进行多个或选择的多个进行拖动或可选把多个进行删除操作" + "</li>" + "<li>" + "居中显示：可将整个IP进行自动缩放并居中显示" + "</li>" + "<li>" + "全屏显示：当点击这个功能入口会启用浏览器的全屏模式显示画布;" + "</li>" + "<li>" + "保存状态：可将页面中的点保存起来;" + "</li>" + "<li>" + "请求保存：可将上次的保存重新渲染在页面;" + "</li>" + "<li>" + "显示/取消IP：将所有的IP文字显示/取消显示在画布；" + "</li>" + "<li>" + "导出PNG:将画布上所有的对象生成PNG图片并在浏览器另一窗口打开；" + "</li>" + "<li>" + "匹配用户设置:可将您设置的网段在此页面进行聚合" + "</li>" + "<li>" + "在空白处右键：" + "</li>" + "<li>" + "隐藏/显示工具栏：可对工具栏进行隐藏显示操作" + "</li>" + "<li>" + "在IP点上右键：" + "</li>" + "<li>" + "复制当前对象IP：会出现一个输入框;需要ctrl+A、ctrl+C进行复制;" + "</li>" + "<li>" + "以此为中心显示：当一个点与多个点相连时;中心点却不是此点;可进行此操作对当前页面进行重新渲染;" + "</li>" + "<li>" + "删除对象：可对当前对象或选中为高亮状态的对象进行删除(通过鼠标右键或键盘DELETE键);" + "</li>" + "<li>" + "在连线上右键：" + "</li>" + "<li>" + "修改颜色（随机）：可随机更改连线的颜色 ；" + "</li>" + "<li>" + "连线加粗：每点击一次连线加粗1个单位；" + "</li>" + "<li>" + "连线变细：每点击一次连线减细1个单位，直到小于1则不再减小；" + "</li>" + "<li>" + "变成虚线：将连线变成虚线；" + "</li>" + "<li>" + "变成实线：将连线变成实线；" + "</li>" + "</ul>";
                ...
                "Rclick": {
                    "delNode": function() {
                        ...
                        if (selectAllNode.length != 0) {
                            ...
                            $(".addOption").parent().addClass("hide");
                            $(".modal-body-div").text("执行删除" + selectAllNode.length + "个节点且不可恢复，确定要这样操作吗？").removeClass("hide");
                            $(".f-click").show();
                            $("#myModal").modal('show');
                            $(".t-click").click(function() {
                    ...
                    "linkValue": function(kpiOptionVal, dataVal, linkName) {
                        ...
                        case "21":
                            ...
                            if (((dataVal / 1024) / 1024) / 1024 - 1 >= 0) {
                                ...
                                if (parseInt((((dataVal / 1024) / 1024) / 1024) * (255 / 1024)) >= 255) {
                                    ...
                                    linkName.strokeColor = parseInt((((dataVal / 1024) / 1024) / 1024) * (255 / 1024)) + ",0,255";
                                }
                                if ((((dataVal / 1024) / 1024) / 1024) % parseInt((((dataVal / 1024) / 1024) / 1024))) {
                                ...
                                linkName.strokeColor = "0," + 255 - parseInt(((dataVal / 1024) / 1024) * (255 / 1024)) + ",255";
                                if (((dataVal / 1024) / 1024) % parseInt(((dataVal / 1024) / 1024))) {
                        ...
                        case "22":
                            ...
                            if ((dataVal / 1000) / 60 - 1 >= 0) {
                                ...
                                if (((dataVal / 1000) / 60) % parseInt(((dataVal / 1000) / 60))) {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                data.forEach(function(item) {
                                    ...
                                    resultArry = [],
                                    //将得到的范围值存给变量 将页面中的点与这范围进行筛选并将筛选结果赋值给resultArry数组
                                    x = Math.random() * parseInt(window.innerWidth * 0.6) + parseInt(window.innerWidth * 0.2),
                                    y = Math.random() * parseInt((window.innerHeight - $(".navbar-logo").height() - 20) * 0.6) + parseInt((window.innerHeight - $(".navbar-logo ").height() - 20) * 0.2),
                                    ...
                                    scene.childs.forEach(function(jtem) {
                                        if (jtem.elementType == "node") {
                                            if (jtem.tip.indexOf("/") == -1) {
                                                ...
                                                if (s1 != "") {
                                                    if (t1 != "") {
                                                        if (nodeTip[0] >= s1 && nodeTip[0] <= t1 && nodeTip[1] >= s2 && nodeTip[1] <= t2 && nodeTip[2] >= s3 && nodeTip[2] <= t3 && nodeTip[3] >= s4 && nodeTip[3] <= t4) {
                                                ...
                                                if (js1 != "") {
                                                    if (jt1 != "") {
                                                        if (js1 >= s1 && js1 <= t1 && js2 >= s2 && js2 <= t2 && js3 >= s3 && js3 <= t3 && js4 >= s4 && js4 <= t4 && jt1 >= s1 && jt1 <= t1 && jt2 >= s2 && jt2 <= t2 && jt3 >= s3 && jt3 <= t3 && jt4 >= s4 && jt4 <= t4) {
                                                            resultArry.push(jtem);
                                                        }
                                                    } else {
                                                        if (js1 >= s1 && js1 <= t1 && js2 >= s2 && js2 <= t2 && js3 >= s3 && js3 <= t3 && js4 >= s4 && js4 <= t4) {
                                                            resultArry.push(jtem);
                                                        }
                                                    }
                                                }
                                                                ...
                                                                if (centerNewNode.outLinks && centerNewNode.outLinks.length) {
                                                                    ...
                                                                    if (centempArry.indexOf(eNode.nodeInlinks[i].nodeA.tip) == -1) {
                                                                        ...
                                                                        if (kpiVal != 1 && kpiVal != 20 && kpiVal != 21 && kpiVal != 10 && kpiVal != 11 && kpiVal != 12 && kpiVal != 13) {
                                                                            ...
                                                                            portal.Jnode.linkValue(kpiVal, centerNewNode.outLinks[centempArry.indexOf(eNode.nodeInlinks[i].nodeA.tip)].tiptext, centerNewNode.outLinks[centempArry.indexOf(eNode.nodeInlinks[i].nodeA.tip)]);
                                                                        }
                                                                    }
                                                                } else {
                                                                    var tlink = newLink(centerNewNode, scNode);
                                                                ...
                                                                if (centerNewNode.outLinks && centerNewNode.outLinks.length) {
                                                                    ...
                                                                    if (centempArry.indexOf(eNode.nodeOutlinks[i].nodeZ.tip) == -1) {
                                                                        ...
                                                                        if (kpiVal != 1 && kpiVal != 20 && kpiVal != 21 && kpiVal != 10 && kpiVal != 11 && kpiVal != 12 && kpiVal != 13) {
                                                                            ...
                                                                            portal.Jnode.linkValue(kpiVal, centerNewNode.outLinks[centempArry.indexOf(eNode.nodeOutlinks[i].nodeZ.tip)].tiptext, centerNewNode.outLinks[centempArry.indexOf(eNode.nodeOutlinks[i].nodeZ.tip)]);
                                                                        }
                                                                    }
                                                                } else {
                                                                    var tlink = newLink(centerNewNode, scNode);
                                                            ...
                                                            portNodeArray.forEach(function(portNode, index) {
                                                                if (portNode.tip == event.target.portText) {
                                                                    ...
                                                                    if (event.target.y - event.target.inLinks[0].nodeA.y) {
                                                                        portNode.y = Math.abs((event.target.y - event.target.inLinks[0].nodeA.y) / 2) + Math.min(event.target.y, event.target.inLinks[0].nodeA.y);
                                                                    } else {
                                            ...
                                            $.ajax({
                                                ...
                                                success: function(search) {
                                                    ...
                                                    if (search.length) {
                                                        ...
                                                        var searchNode = newCircleNode(parseInt(window.innerWidth * 0.7), parseInt((window.innerHeight - $(".navbar-logo ").height() - 20) * 0.3), event.target.tip, color);
                                                        searchNode.radius = 8;
